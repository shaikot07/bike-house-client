...
const TopBrand = () => {
  ...
  <h2 className="text-3xl font-extrabold pb-8">Top Brands</h2>
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 bg-pink-700">
    {/* Card 1 */}
    <div className="relative isolate flex flex-col justify-end overflow-hidden rounded-xl px-6 pb-2 pt-6 transition-transform duration-300 hover:-translate-y-2 hover:cursor-pointer">
      ...
      <h3 className="z-10 mt-20 text-base font-bold text-white">ChargeUp</h3>
    </div>
    ...
    <div className="relative isolate flex flex-col justify-end overflow-hidden rounded-xl px-6 pb-2 pt-6 transition-transform duration-300 hover:-translate-y-2 hover:cursor-pointer">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/0"></div>
      <h3 className="z-10 mt-20 text-base font-bold text-white">Rugged Path</h3>
    </div>
    ...
    <div className="relative isolate flex flex-col justify-end overflow-hidden rounded-xl px-6 pb-2 pt-6 transition-transform duration-300 hover:-translate-y-2 hover:cursor-pointer">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/0"></div>
      <h3 className="z-10 mt-20 text-base font-bold text-white">Off RoadX</h3>
    </div>
